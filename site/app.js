...
var _dmsnell$photosynthesis$Main$networkSpinnerHtml = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('network-spinner'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('network-spinner__1'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('network-spinner__2'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('network-spinner__3'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('network-spinner__4'),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('network-spinner__5'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
...
var _dmsnell$photosynthesis$Main$networkSpinner = function (isActive) {
	return isActive ? _dmsnell$photosynthesis$Main$networkSpinnerHtml : _elm_lang$html$Html$text('');
};
var _dmsnell$photosynthesis$Main$rawHtml = function (_p0) {
	return A2(
		_elm_lang$html$Html_Attributes$property,
		'innerHTML',
		_elm_lang$core$Json_Encode$string(_p0));
};
var _dmsnell$photosynthesis$Main$view = function (model) {
	var joinClasses = function (_p1) {
		return A2(
			_elm_lang$core$String$join,
			' ',
			A2(
		...
		switch (_p3.ctor) {
			case 'NoSiteGiven':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Add a site in the URL query string: e.g. \'?site=design.blog\''),
						_1: {ctor: '[]'}
					});
			case 'Site':
				var posts = _elm_lang$core$List$reverse(
					_elm_lang$core$Dict$values(model.postList.posts));
				var es = _elm_lang$core$Maybe$withDefault('');
				var post = function (_p4) {
					var _p5 = _p4;
					var _p6 = _p5.content;
					var excerptClasses = joinClasses(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'excerpt', _1: true},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'short',
									_1: !(false || (A2(_elm_lang$core$String$endsWith, '[&hellip;]</p>\n', _p6) || A2(_elm_lang$core$String$endsWith, '&hellip;</p>\n', _p6)))
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_1: (_elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$String$length(_p6),
											80) > 0) && ((_elm_lang$core$Native_Utils.cmp(
											_elm_lang$core$String$length(_p6),
											160) < 0) && (!A2(_elm_lang$core$String$contains, '<br', _p6)))
									},
									_1: {ctor: '[]'}
								}
							}
						});
					var excerptContainerClasses = joinClasses(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'excerpt-container', _1: true},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'empty',
									_1: _elm_lang$core$String$isEmpty(_p6)
								},
								_1: {ctor: '[]'}
							}
						});
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(excerptContainerClasses),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class(excerptClasses),
												_1: {
													ctor: '::',
													_0: _dmsnell$photosynthesis$Main$rawHtml(_p6),
													_1: {ctor: '[]'}
												}
											},
											{ctor: '[]'}),
				...
				return A2(
					...
					A2(_elm_lang$core$List$map, post, posts));
			default:
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _dmsnell$photosynthesis$Main$networkSpinner(model.isNetworkActive),
			_1: {
				ctor: '::',
				_0: body,
				_1: {ctor: '[]'}
...
var _dmsnell$photosynthesis$Main$PostList = F5(
	function (a, b, c, d, e) {
		return {site: a, totalPosts: b, perPage: c, nextPage: d, posts: e};
	});
var _dmsnell$photosynthesis$Main$Model = F3(
	function (a, b, c) {
		return {isNetworkActive: a, postList: b, route: c};
	});
var _dmsnell$photosynthesis$Main$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _dmsnell$photosynthesis$Main$RequestNextPage = {ctor: 'RequestNextPage'};
var _dmsnell$photosynthesis$Main$subscriptions = function (model) {
	return _dmsnell$photosynthesis$Main$requestNextPage(
		_elm_lang$core$Basics$always(_dmsnell$photosynthesis$Main$RequestNextPage));
};
var _dmsnell$photosynthesis$Main$ReceivePosts = F2(
	function (a, b) {
		return {ctor: 'ReceivePosts', _0: a, _1: b};
	});
var _dmsnell$photosynthesis$Main$NetworkSuccess = function (a) {
	return {ctor: 'NetworkSuccess', _0: a};
};
var _dmsnell$photosynthesis$Main$NetworkRequest = function (a) {
	return {ctor: 'NetworkRequest', _0: a};
};
var _dmsnell$photosynthesis$Main$fetchPosts = function (postList) {
	var pageHandle = A2(
		...
		A2(
			...
			function (s) {
				return {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'page_handle', _1: s},
					_1: {ctor: '[]'}
				};
			},
			postList.nextPage));
	var queryParams = A2(
		...
		pageHandle,
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'number',
				_1: _elm_lang$core$Basics$toString(postList.perPage)
			},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'fields', _1: 'ID,date,title,excerpt,URL,attachments'},
				_1: {ctor: '[]'}
			}
		});
	var attributes = A2(
	...
	var decoder = A3(
		...
		_dmsnell$photosynthesis$Main$ReceivePosts,
	...
	var url = A2(
		...
		A2(_elm_lang$core$Basics_ops['++'], postList.site, '/posts'));
	return _dmsnell$photosynthesis$Main$NetworkRequest(
		A2(
...
var _dmsnell$photosynthesis$Main$fetchNextPage = function (postList) {
	return A2(
		_elm_lang$core$Maybe$map,
		_elm_lang$core$Basics$always(
			_dmsnell$photosynthesis$Main$fetchPosts(postList)),
		postList.nextPage);
};
var _dmsnell$photosynthesis$Main$NetworkError = {ctor: 'NetworkError'};
var _dmsnell$photosynthesis$Main$SiteNotFound = {ctor: 'SiteNotFound'};
var _dmsnell$photosynthesis$Main$Site = function (a) {
	return {ctor: 'Site', _0: a};
};
var _dmsnell$photosynthesis$Main$model = {
	isNetworkActive: false,
	postList: _dmsnell$photosynthesis$Main$postList,
	route: _dmsnell$photosynthesis$Main$Site(_dmsnell$photosynthesis$Main$postList.site)
};
var _dmsnell$photosynthesis$Main$NoSiteGiven = {ctor: 'NoSiteGiven'};
var _dmsnell$photosynthesis$Main$routeParser = function () {
	var defaultSite = _dmsnell$photosynthesis$Main$Site(_dmsnell$photosynthesis$Main$postList.site);
	var siteRoute = function (s) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			defaultSite,
			A2(
				_elm_lang$core$Maybe$map,
				function (s) {
					return _elm_lang$core$String$isEmpty(s) ? _dmsnell$photosynthesis$Main$NoSiteGiven : _dmsnell$photosynthesis$Main$Site(s);
				},
				s));
	};
	return _evancz$url_parser$UrlParser$oneOf(
		{
			...
			_0: A2(
				...
				A2(
					...
					_evancz$url_parser$UrlParser$stringParam('site'))),
			_1: {
				ctor: '::',
				_0: A2(_evancz$url_parser$UrlParser$map, defaultSite, _evancz$url_parser$UrlParser$top),
				_1: {ctor: '[]'}
			}
		});
}();
var _dmsnell$photosynthesis$Main$parseRoute = function (_p8) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_dmsnell$photosynthesis$Main$SiteNotFound,
		A2(_evancz$url_parser$UrlParser$parseHash, _dmsnell$photosynthesis$Main$routeParser, _p8));
};
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p9.ctor) {
				...
				case 'NetworkRequest':
					var toMsg = function (response) {
						return A2(
							_elm_lang$core$Result$withDefault,
							_dmsnell$photosynthesis$Main$NetworkError,
							A2(_elm_lang$core$Result$map, _dmsnell$photosynthesis$Main$NetworkSuccess, response));
					};
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
						...
						_1: A2(_lukewestby$elm_http_builder$HttpBuilder$send, toMsg, _p9._0)
					};
				case 'NetworkSuccess':
					var _v3 = _p9._0,
					...
					continue update;
				case 'ReceivePosts':
					var validPost = function (_p10) {
						var _p11 = _p10;
						var url = A2(_elm_lang$core$Maybe$withDefault, '', _p11.imageUrl);
						return A2(
							_elm_lang$core$List$any,
					...
					var oldPostList = model.postList;
					var newPosts = A3(
						...
						_elm_lang$core$Dict$fromList(
							A2(
								...
								A2(_elm_lang$core$List$filter, validPost, _p9._1))));
					var newPostList = _elm_lang$core$Native_Utils.update(
						oldPostList,
						{posts: newPosts, nextPage: _p9._0});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				case 'RequestNextPage':
					return model.isNetworkActive ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : A2(
						_elm_lang$core$Maybe$withDefault,
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none},
						A2(
							_elm_lang$core$Maybe$map,
							function (m) {
								return A2(_dmsnell$photosynthesis$Main$update, m, model);
							},
							_dmsnell$photosynthesis$Main$fetchNextPage(model.postList)));
				default:
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								route: _dmsnell$photosynthesis$Main$parseRoute(_p9._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			}
...
var _dmsnell$photosynthesis$Main$init = function (location) {
	...
	var nextModel = _elm_lang$core$Native_Utils.update(
		_dmsnell$photosynthesis$Main$model,
		{postList: nextPostList, route: route});
	return A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '_Tuple2', _0: nextModel, _1: _elm_lang$core$Platform_Cmd$none},
		A2(
			_elm_lang$core$Maybe$map,
			function (m) {
				return A2(_dmsnell$photosynthesis$Main$update, m, nextModel);
			},
			startFetching));
};
var _dmsnell$photosynthesis$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_dmsnell$photosynthesis$Main$UrlChange,
	{init: _dmsnell$photosynthesis$Main$init, subscriptions: _dmsnell$photosynthesis$Main$subscriptions, update: _dmsnell$photosynthesis$Main$update, view: _dmsnell$photosynthesis$Main$view})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _dmsnell$photosynthesis$Main$main !== 'undefined') {
    _dmsnell$photosynthesis$Main$main(Elm['Main'], 'Main', undefined);
}
