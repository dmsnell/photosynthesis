	...
	switch (_p3.ctor) {
		...
		case 'Site':
			...
			var posts = A2(
				...
				(_p3._1 + 1) * model.postList.perPage,
				_elm_lang$core$List$reverse(
					A2(
						_elm_lang$core$List$filter,
						function (_p4) {
							var _p5 = _p4;
							var _p6 = _p5.imageUrl;
							return _elm_community$maybe_extra$Maybe_Extra$isJust(_p6) && (!A2(
								_elm_lang$core$String$endsWith,
								'.mov',
								es(_p6)));
						},
						_elm_lang$core$Dict$values(model.postList.posts))));
			var post = function (_p7) {
				var _p8 = _p7;
				var _p9 = _p8.content;
							...
							_1: {
								...
								_0: {
									...
									_1: (_elm_lang$core$Native_Utils.cmp(
										...
										_elm_lang$core$String$length(_p9),
										160) < 0) && (!A2(_elm_lang$core$String$contains, '<br', _p9)))
								},
								_1: {ctor: '[]'}
							}
						}
				...
				var excerptContainerClasses = joinClasses(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'empty',
								_1: _elm_lang$core$String$isEmpty(_p9)
							},
							_1: {ctor: '[]'}
						}
					});
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{
											...
											_1: {
												ctor: '::',
												_0: _dmsnell$photosynthesis$Main$rawHtml(_p9),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
...
var _dmsnell$photosynthesis$Main$Model = F2(
	function (a, b) {
		return {postList: a, route: b};
	});
...
var _dmsnell$photosynthesis$Main$parseRoute = function (_p12) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_dmsnell$photosynthesis$Main$SiteNotFound,
		A2(_evancz$url_parser$UrlParser$parseHash, _dmsnell$photosynthesis$Main$routeParser, _p12));
};
var _dmsnell$photosynthesis$Main$init = function (location) {
	...
	var startFetching = function () {
		var _p14 = route;
		if (_p14.ctor === 'Site') {
			return _dmsnell$photosynthesis$Main$fetchPosts(nextPostList);
		} else {
		...
		if (_p15.ctor === 'ReceivePosts') {
			...
			var newPosts = A3(
				...
				_elm_lang$core$Dict$fromList(
					A2(
						_elm_lang$core$List$map,
						function (post) {
							return {ctor: '_Tuple2', _0: post.id, _1: post};
						},
						_p15._0)));
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						route: _dmsnell$photosynthesis$Main$parseRoute(_p15._0)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
